<html>
    <head>
       ...
       JQuery
        ...
        <script src="/Scripts/CribScript.js"></script>
    </head>
    <body>
        <?PHP
        require "Header.php";
        ?>
        <p>The following are experimental features. If you would like, please try them out and report any issues you have on GitHub, accessible in the "Help" page</p>
        <ul>
